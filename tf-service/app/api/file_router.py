...
@router.get("/mozaic")
async def file_mozaic():
    girl = './original/girl.jpg'
    cascade = './original/haarcascade_frontalface_alt.xml'
    ...
    cv2.imwrite('./output/girl-face.png',img)
    cv2.imshow('./output/girl-face',img)
    cv2.waitKey(0)
